      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 items-end justify-between">
            ...
            <div className="h-24 w-24 bg-red-400 rounded-full group-hover:bg-blue-400 transition-colors"></div>
            <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="bg-blue-200 justify-center items-center aspect-square w-8 text-xl text-gray-500 rounded-md">
                -
              </button>
              <span>1</span>
              <button className="bg-blue-200 justify-center items-center aspect-square w-8 text-xl text-gray-500 rounded-md">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 py-2 px-8 text-center text-xs text-white rounded-md">
              Add to Cart
            </button>
          </div>
        </div>
