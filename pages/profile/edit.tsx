  ...
  return (
    <div className="py-10 px-4 space-y-4">
      <div className="flex items-center space-x-3">
        ...
        <label
          htmlFor="picture"
          className="cursor-pointer py-2 px-3 border-gray-300 rounded-md shadow-sm text-sm font-medium focus:ring-2 border focus:ring-offset-2 focus:ring-orange-500 text-gray-700"
        >
          Change photo
